Feature: User Module test scripts
  ...
  Scenario Outline: Verify create and delete user functionality2
    ...
    Examples:
      ...
      | http://localhost:81/login.do | admin    | manager  | SG1            | user1         | sg1.user1@sg.com | sg1user1      | Mercury1      | Mercury1            |
      | http://localhost:81/login.do | admin    | manager  | SG2            | user2         | sg2.user1@sg.com | sg2user1      | Mercury1      | Mercury1            |
